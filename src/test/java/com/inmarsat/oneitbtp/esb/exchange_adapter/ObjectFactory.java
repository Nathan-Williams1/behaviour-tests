 ...
 * generated in the com.inmarsat.oneitbtp.esb.exchange_adapter package. 
...
public class ObjectFactory {
    ...
    private final static QName _EXCHANGERATERESPONSE_QNAME = new QName("http://esb.oneitbtp.inmarsat.com/exchange_adapter", "EXCHANGE_RATE_RESPONSE");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.inmarsat.oneitbtp.esb.exchange_adapter
     * 
     */
